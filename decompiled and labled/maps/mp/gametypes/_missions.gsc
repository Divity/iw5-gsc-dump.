...
ch_kills( var_0, var_1 )
{
    ...
    if ( var_0.sMeansOfDeath == "MOD_PISTOL_BULLET" || var_0.sMeansOfDeath == "MOD_RIFLE_BULLET" )
    {
        ...
        else
        {
            ...
            endswitch( 7 )  case "weapon_handgun" loc_15AC case "weapon_machine_pistol" loc_15BC case "weapon_shotgun" loc_158C case "weapon_sniper" loc_159C case "weapon_assault" loc_157C case "weapon_smg" loc_156C default loc_15CC
        }
    }
